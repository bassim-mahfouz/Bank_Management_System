...
{
    public partial class elevent2Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastPaidInstallment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LoanDeadline = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AmountPaidPerInstallment = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Actions_Employees_EmployeeName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaidInstallment", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaidInstallment_LoanId",
